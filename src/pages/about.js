...
const about = () => {
  return (
    ...
    <main className='flex w-full flex-col items-center justify-center dark:bg-dark'>
            ...
            <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark dark:border-light bg-light dark:bg-dark p-8'>
                ...
                <div className='col-span-2 flex flex-col item-end  justify-between'>
                    <div className='flex flex-col items-end justify-center'>
                        ...
                        <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75'>+ Year&apos;s Of Experience</h2>
                    </div>
                </div>
            </div>
        </div>
